...
Bimgur offers two client applications:
...
* Allows scientists to create new BimgurFX users
* Allows scientist to define new BimgurFX image analysis workflows

Technically, this is a web application which can be accessed through a browser.
This application is provided out out-of-the-box by the http://activiti.org[Activiti project].
...
Installing a server, a database, and deploying custom code can be tedious.
